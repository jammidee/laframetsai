...
SecurityRoutes.use("/getaccesstoken", get_access_token_1.accessToken);
SecurityRoutes.get("/validatetoken", jwt_generate_1.authenticateToken, validate_token_1.validateToken);
